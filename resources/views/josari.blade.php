...
<html lang="en">
    <head>
        ...
        <title>Desa Josari Tejoku</title>
    </head>
    <body>
        <!--==================== HEADER ====================-->
      ...
      <section>
        <div class="swiper-container gallery-top">
          <div class="swiper-wrapper">
            ...
            <!--========== ISLANDS 2 ==========-->
            <section class="islands swiper-slide">
              <img src="{{ asset('assets/img/josari3.jpg') }}" alt="" class="islands__bg" />
        ...
        <div class="controls gallery-thumbs">
          <div class="controls__container swiper-wrapper">
            ...
            />
            <img
              src="{{ asset('assets/img/josari3.jpg') }}"
              alt=""
              class="controls__img swiper-slide"
            />
            <img
        ...
        <div class="blog__container container">
          <div class="content__container">
            <div class="blog__detail">
              <p>
              Desa Josari di Kabupaten Ponorogo dikenal dengan produk UMKM unggulannya, Jenang Mirah, yang memiliki cita rasa khas dan menjadi oleh-oleh favorit. 
              Selain itu, desa ini juga memiliki nilai religius dengan keberadaan Makam Rais Syuriah, tokoh agama berpengaruh di daerah tersebut. 
              Desa Josari menggabungkan tradisi kuliner dengan sejarah spiritual, menjadikannya destinasi yang unik.
              </p>
            </div>
            <div class="package-travel">
              <h3>Lokasi Desa Josari</h3>
              <div class="card">
                <h1><b>Alamat</b></h1>
                Josari, Kec. Jetis, Kabupaten Ponorogo, Jawa Timur
                <br />
              </div>
            </div>
          </div>
                ...
                <div class="popular__container swiper gallery">
                    <div class="swiper-wrapper">
                        <article class="popular__card swiper-slide">
                            <a href="#">
                                <img src="{{ asset('assets/img/jo1.jpg') }}" alt="" class="popular__img" />
                        ...
                        <article class="popular__card swiper-slide">
                            <a href="#">
                                <img src="{{ asset('assets/img/jo2.jpg') }}" alt="" class="popular__img" />
                                <div class="popular__data">
                                    <h3 class="popular__title" style="text-align: center;">
                                       Makam Rais Syuriah
                                    </h3>
                        ...
                        <article class="popular__card swiper-slide">
                            <a href="#">
                                <img src="{{ asset('assets/img/reog.jpg') }}" alt="" class="popular__img" />
                                <div class="popular__data">
                                    <h3 class="popular__title" style="text-align: center;">
                                       Reog Ponorogo
                                    </h3>
