...
<html lang="en">
    <head>
        ...
        <title>Desa Tegalsari Tejoku</title>
    </head>
    <body>
        <!--==================== HEADER ====================-->
      ...
      <section>
        <div class="swiper-container gallery-top">
          <div class="swiper-wrapper">
            ...
            <section class="islands swiper-slide">
              <img src="{{ asset('assets/img/tegal1.jpg') }}" alt="" class="islands__bg" />
            ...
            <!--========== ISLANDS 3 ==========-->
            <section class="islands swiper-slide">
              <img src="{{ asset('assets/img/ndalem.jpg') }}" alt="" class="islands__bg" />
        ...
        <div class="controls gallery-thumbs">
          <div class="controls__container swiper-wrapper">
            <img
              src="{{ asset('assets/img/tegal1.jpg') }}"
              alt=""
            ...
            />
            <img
              src="{{ asset('assets/img/ndalem.jpg') }}"
              alt=""
              class="controls__img swiper-slide"
            />
          </div>
        ...
        <div class="blog__container container">
          <div class="content__container">
            <div class="blog__detail">
              <p>
              Desa Tegalsari dikenal dengan Masjid Tegalsari, sebuah objek wisata religi bersejarah yang menarik banyak pengunjung. 
              Masjid ini memiliki nilai budaya dan spiritual tinggi, menjadi pusat ziarah bagi umat Muslim. 
              Selain itu, UMKM di desa ini mendukung sektor pariwisata dengan menyediakan berbagai produk oleh-oleh khas seperti makanan tradisional dan kerajinan tangan. 
              Masyarakat juga mengelola jasa wisata, seperti pemandu tur dan penginapan. 
              Sinergi antara potensi wisata religi dan UMKM membuat Desa Tegalsari berkembang sebagai destinasi wisata unggulan.
              </p>
            </div>
            <div class="package-travel">
              <h3>Lokasi Desa Tegalsari</h3>
              <div class="card">
                <h1><b>Alamat</b></h1>
                Tegalsari, Kec. Jetis, Kabupaten Ponorogo, Jawa Timur
                <br />
              </div>
            </div>
          </div>
            ...
            <div class="container">
                ...
                <div class="popular__container swiper gallery">
                    <div class="swiper-wrapper">
                        ...
                        <article class="popular__card swiper-slide">
                            <a href="#">
                                <img src="{{ asset('assets/img/tegal1.jpg') }}" alt="" class="popular__img" />
                                <div class="popular__data">
                                    <h3 class="popular__title" style="text-align: center;">
                                        Makam Agung Kiai Ageng
                                    </h3>
                                </div>
                            </a>
                        </article>
                        <article class="popular__card swiper-slide">
                            <a href="#">
                                <img src="{{ asset('assets/img/ndalem.jpg') }}" alt="" class="popular__img" />
                                <div class="popular__data">
                                    <h3 class="popular__title" style="text-align: center;">
                                       Dalem Ageng Kiai Ageng
                                    </h3>
                                    </div>
                            </a>
                        </article>
